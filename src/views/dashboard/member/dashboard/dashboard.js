...
//     const cweight = data.current_weight || 0
//     const tweight = data.target_weight || 0
...
//                         {localStorage.getItem("totalCalories") || 0}
//                       </div>
//                       <div style={{ color: "gray", fontSize: "14px" }}>LEFT</div>
//                       <div style={{ color: "gray", fontSize: "20px" }}>
//                         {Math.floor(calsRequired - (+localStorage.getItem("totalCalories") || 0))}
//                       </div>
//                     </div>
//                   </CircularProgress>
//                 </VStack> */}
